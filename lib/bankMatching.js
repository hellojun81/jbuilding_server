  ...
  const candidates = bills
    .map((bill) => {
      ...
      return {
        ...
        nameMatched,
        learnedMatch,
        existingMatchId: bill.existing_match_id ? Number(bill.existing_match_id) : null,
        existingTransactionId: bill.existing_transaction_id ? Number(bill.existing_transaction_id) : null,
        existingDepositAmount: Number(bill.existing_deposit_amount || 0),
        existingPayer: String(bill.existing_payer || ''),
